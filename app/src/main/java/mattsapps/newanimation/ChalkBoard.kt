...
(context: Context) : View(context) {
    ...
    private var angle = 90.0f        //angle of rotation used to animate rotations
    ...
    fun wander() {
        ...
        when (style) {
            ...
            MATTS_ANIM_1 -> {
                val new = ObjectAnimator.ofFloat(this,"rotationY",0f,720.0f)
                new.duration = 2000
                new.start()
            }
            MATTS_ANIM_2 ->{
                val newer = ObjectAnimator.ofFloat(this,"rotationX",0f,720.0f)
                newer.duration = 2000
                newer.start()
    ...
    private fun getObjectAnimator(duration: Int, variable: String, initialValue: Float, finalValue: Float): ObjectAnimator {
        animation = ObjectAnimator.ofFloat(this, variable, initialValue, finalValue)
    ...
    companion object {  //static stuff
        ...
        const val MATTS_ANIM_1 = 31
        const val MATTS_ANIM_2 = 32
    }
}